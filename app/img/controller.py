...
class Runner():    
	...
	def on_event(self, args):
		...
		# # Collected firs 10 for each tag
		# if msg == "trends":
		#     action = args[1]
		#     # if action == "downloaded":
